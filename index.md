...
address: "Avenida 12 de Octubre 1076 y Vicente Ramón Roca. Faultad de Ciencias Exactas y Naturales. Escuela de Biología. Sala de uso multiple (2nd piso)"      # dirección completa del espacio donde se realizará el taller (por ejemplo, "Aula 3, Av. Córdoba 1234, Buenos Aires, Argentina")
...
helper: ["Cornelia Brito", "Eduardo Atiencia", "Diego Arias"]     # lista de nombres de las **helpers** separados por comas y entre corchetes, como ["Carrie Fisher", "Frances Allen", "Margaret Hamilton"]
...
<h4>Registrarse aquí (Máximo 20 participantes): <a href="https://www.eventbrite.com/e/swc-ecuador-shell-r-y-git-tickets-290009796107">EventBrite-Tickets-SWC-Ecuador-PUCE</a></h4>
